...
interface ISalesByStationTable {
  data: Array<{ [key: string]: string | number | undefined | null }>;
}
export const SalesByStationTable = ({ data }: ISalesByStationTable) => {
  return (
    <Table className={"table"}>
      <thead>
        <tr className={"table-light"}>
          ...
          <AlignHeader rowSpan={2}>급속</AlignHeader>
          <AlignHeader rowSpan={2}>완속</AlignHeader>
