...
import { SalesByStationTable } from "src/pages/Sales/components/SalesByStationTable";
          ...
          <Row className={"my-4 align-items-center"}>
            <Col>
              <span className={"text-size-13 fw-bold"}>
                총 <span className={"text-turu"}>0건</span>의 충전소 매출 정보가
                있습니다.
              </span>
            </Col>
